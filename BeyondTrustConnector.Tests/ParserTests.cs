...
public class ParserTests
{
    ...
    [InlineData("Dec 10 07:34:19 tenant BG[19414]: 1427:01:01:site=tenant.beyondtrustcloud.com;when=1733812459;who=API \\;User (09415e9d78c193c8b2a5d5154e1102574beafdf1);who_ip=1.2.3.4;event=login;target=web/api;status=failure")]
    public void ItCanParseBeyondTrustSyslog(string logEntry)
    {
        var parser = new BeyondTrustLogParser(logEntry);
        var entries = parser.Parse();
        Assert.Single(entries);
    }

    [Fact]
    public void ItCanParseMultiLineLog()
    {
        var log = @"
...
Dec 10 07:34:19 tenant BG[19414]: 1427:01:01:site=tenant.beyondtrustcloud.com;when=1733812459;who=API User (09415e9d78c193c8b2a5d5154e1102574beafdf1);who_ip=1.2.3.4;event=login;target=web/api;status=success
Dec 10 07:34:19 tenant BG[19414]: 1427:01:01:site=tenant.beyondtrustcloud.com;when=1733812459;who=API \\;User (09415e9d78c193c8b2a5d5154e1102574beafdf1);who_ip=1.2.3.4;event=login;target=web/api;status=failure
            ";
